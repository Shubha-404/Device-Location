...
class LocationManager {
    ...
    fun getUserLocation(context: MainActivity): LatandLong {
            ...
            locationCallback = object : LocationCallback() {
                override fun onLocationResult(result: LocationResult) {
                    ...
                    for (location in result.locations) {
                        ...
                        Log.d("LocationManager", "${location.latitude},${location.longitude}")
                    }
        ...
        try {
            ...
            removeTask.addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    Log.d("LocationManager", "Location Callback removed.")
                } else {
                    Log.d("LocationManager", "Failed to remove Location Callback.")
                }
            }
        } catch (se: SecurityException) {
            Log.e("LocationManager", "Failed to remove Location Callback.. $se")
        }
    }
